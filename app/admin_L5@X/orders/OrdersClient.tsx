  ...
  return (
    <>
      <div className="mb-4 flex space-x-2">
        ...
        <button onClick={() => setFilter('payment_pending')} className={`px-4 py-2 rounded-lg font-semibold transition-all duration-300 ${filter === 'payment_pending' ? 'bg-gradient-to-r from-[#9ECFD4] via-[#78B9B5] to-[#016B61] text-black shadow-md' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>Payment Pending</button>
