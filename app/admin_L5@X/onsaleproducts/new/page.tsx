...
const AddOnSaleProductPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
        const result = await addOnSaleProduct(formData);
        if (result.success) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Add New On Sale Product</h1>
...
export default AddOnSaleProductPage;
