...
export default function Navbar() {
  ...
  const { cartCount } = useCart(); // ✅ 2. Get cartCount from context
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            >
              ...
              {cartCount > 0 && (
                <span 
                  className="absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-pink-600 text-white text-xs font-black rounded-full min-w-[20px] h-5 flex items-center justify-center px-1.5 shadow-lg border-2 border-white animate-pulse-scale"
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            {/* ✅ 4. Mobile Cart Button with Counter */}
            <Link
              href="/Cart"
              className="relative p-2 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:scale-110"
            ...
            >
              ...
              />
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-pink-600 text-white text-[10px] font-black rounded-full min-w-[16px] h-4 flex items-center justify-center px-1 shadow-lg border border-white">
                  {cartCount > 99 ? '99+' : cartCount}
                </span>
              )}
            </Link>
