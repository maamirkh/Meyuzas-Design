          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg border-2 border-transparent hover:border-black transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <Link href="mailto:contact@meyuzas.com" className="text-gray-700 hover:text-black transition-colors duration-300">
                    contact@meyuzas.com
                  </Link>
                </div>
            ...
            <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg border-2 border-transparent hover:border-black transition-all duration-300">
              ...
              <div className="h-64 lg:h-80 rounded-xl overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.203670980599!2d-73.98785468459424!3d40.7484403793279!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259865c3b1e7f%3A0x8a9e01f6d3d4b6c!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1678255909090!5m2!1sen!2sus" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
